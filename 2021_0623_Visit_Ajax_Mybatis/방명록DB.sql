...
--이름으로 검색
select * from visit where name like '%길동%'

--내용으로 검색
select * from visit where content like '%1등%'

--이름+내용 검색
select * from visit where name like '%짱구%'
						or content like '%짱구%'

--작성일자별 검색
select * from visit where to_char(regdate,'YYYY-MM-DD') = '2021-06-23'
