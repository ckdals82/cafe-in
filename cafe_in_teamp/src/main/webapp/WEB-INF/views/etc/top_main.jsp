...
<script src='${ pageContext.request.contextPath }/resources/_js/top_main.js'></script>
	...
	<div class="top_main">
      <table>
         <tr>
            ...
            <td></td>
            <td></td>
            <td><div class="top_search_cafe"><input type="button" class="btn btn-warning" value="카페찾기" onclick="location.href='only_menu.do'"></div></td>
            <td></td>
         </tr>
      </table>
   </div>
