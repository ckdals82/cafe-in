...
<!-- bootstrap -->
<link href="${ pageContext.request.contextPath }/resource/bootstrap-3.3.2-dist/css/bootstrap.min.css" rel="stylesheet">
<script src="${ pageContext.request.contextPath }/resource/bootstrap-3.3.2-dist/js/bootstrap.min.js"></script>

<!-- semantic ui -->
<link rel="stylesheet" href="../resource/Semantic-UI-CSS-master/semantic.css">
<script src="${ pageContext.request.contextPath }/resource/Semantic-UI-CSS-master/semantic.js"></script>
...
<!-- common -->
<link rel="stylesheet" href="${ pageContext.request.contextPath }/_css/common.css">
<script src='${ pageContext.request.contextPath }/_js/common.js'></script>

<!-- this page -->
<link rel="stylesheet" href="${ pageContext.request.contextPath }/_css/member_insert_form.css">
<script src='${ pageContext.request.contextPath }/_js/member_insert_form.js'></script>
                 ...
                 <div class="join_page_div">
                   ...
                   <table class="join_table">
                      <tr>
                         ...
                         <td><input id="in_name" class="input_new" placeholder="Name"></td>
                      </tr>
                      <tr>
                         <!-- <td rowspan="6"><img width=150 id="td_star" src="../img/img_photo.png"></td> -->
                         <td class="join_title">아이디</td>
                         <td><input id="in_id" class="input_new" placeholder="ID"><span id="id_msg"></span></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                         <td class="join_title">사진등록</td>
                       <td><input type="file" class="image" accept="image/*" onchange="setThumbnail(event);"/></td>
                      </tr>
                      <tr>
                         <td colspan="2" align="center">
                         <input id="join_button" type="button" class="btn btn-warning btn-ok" value="가입하기"></td>
                      </tr>
                   </table>
                </div>
           </div> 
