...
<script type="text/javascript">
   ...
   function del(m_idx){
	   ...
	   //url-pattern 호출 : javascript-> Servlet호출
  ...
  <div id="main_box">
     ...
     <div class="btn_type">
        ...
        <c:if test="${ not empty sessionScope.user }">
            <b>[${ user.m_name }]</b> 님 로그인하셨습니다
            <input  class="btn  btn-success" type="button"  value="로그아웃"
	                                         onclick="location.href='logout.do'"  >
        </c:if>
            
         <!-- url : http://localhost:9090/2021_0614_MemberTest/member/list.do  <=현재위치
                    http://localhost:9090/2021_0614_MemberTest/member/logout.do<=이동위치 
          -->                                
