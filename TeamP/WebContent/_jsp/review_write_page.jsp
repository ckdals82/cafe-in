...
<!-- this page -->
<link rel="stylesheet" href="../_css/review_write_page.css">
<script src='../_js/review_write_page.js'></script>
            ...
            <table class="table table-striped table-hover">
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <button  onclick="send(this.form);" type="button" style="margin-top:10px;margin-left:5px;" class="btn btn-lg btn-success">Submit</button>
                  </td>
               </tr>
            </table>
               ...
               <table class="table table-striped table-hover">
                  <tr>
                     <td><input style="float: right" type="button" value="저장"></td>
                  </tr>
              </table>
